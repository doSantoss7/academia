    ...
    <div class="mobile-menu-wrapper">
        <div class="mobile-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.html"><img src="{{ asset('/img/logoV.svg') }}" alt="Fitmas"></a>
            </div>
                    ...
                    <div class="row align-items-center justify-content-lg-start justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{ asset('/img/logoV.svg') }}" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="contact-card">
                <div class="info-card">
                    ...
                    <div class="info-card_content">
                        ...
                        <a href="https://www.google.com/maps" class="info-card_link">Av. Marcehal Tito 1500</a>
                    </div>
                </div>
                <div class="info-card">
                    <div class="info-card_icon">
                    ...
                    <div class="info-card_content">
                        ...
                        <a href="vivabem@gmail.com" class="info-card_link">vivabem@gmail.com</a>
                    </div>
                </div>
                <div class="info-card">
                    <div class="info-card_icon">
                    ...
                    <div class="info-card_content">
                        ...
                        <a href="tel:+18925382145" class="info-card_link">+55 (11) 9 13667672</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget footer-widget">
                            ...
                            <div class="sidebar-gallery">
                                <div class="gallery-thumb">
                                    <img src="{{ asset('/img/galeria6.0.jpg') }}" alt="Gallery Image">
                                    <a href="{{ asset('/img/galeria6.0.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="{{ asset('/img/galeria5.0.jpg') }}" alt="Gallery Image">
                                    <a href="{{ asset('/img/galeria5.0.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="{{ asset('/img/galeria4.0.jpg') }}" alt="Gallery Image">
                                    <a href="{{ asset('/img/galeria4.0.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="{{ asset('/img/galeria3.0.jpg') }}" alt="Gallery Image">
                                    <a href="{{ asset('/img/galeria3.0.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="{{ asset('/img/galeria2.0.jpg') }}" alt="Gallery Image">
                                    <a href="{{ asset('/img/galeria2.0.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="{{ asset('/img/galeria1.0.jpg') }}" alt="Gallery Image">
                                    <a href="{{ asset('/img/galeria1.0.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-auto align-self-center"><p class="copyright-text text-center">© 2023 <a href="#">VivaBem São Migeul Paulista.</a> Todos os direitos reservados.</p></div>
                </div>
            </div>
        </div>
    </footer>
